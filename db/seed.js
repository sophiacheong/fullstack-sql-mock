...
const insertMockData = function() {
  var productsArray = createProducts();
  for (var i = 0; i < productsArray.length; i++) {
    db.query(`INSERT INTO products (item, min_cost, curr_bid, ends_in, image) VALUES ('${productsArray[i].item}', ${productsArray[i].min_cost}, ${productsArray[i].curr_bid}, ${productsArray[i].ends_in}, '${productsArray[i].image}')`)
  }
};
